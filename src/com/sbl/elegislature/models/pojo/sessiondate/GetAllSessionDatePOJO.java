...
public class GetAllSessionDatePOJO {

    @JsonProperty("data")
    private List<SessionDateData> data = null;
    ...
    @JsonProperty("data")
    public List<SessionDateData> getData() {
        return data;
    }

    @JsonProperty("data")
    public void setData(List<SessionDateData> data) {
        this.data = data;
    }
